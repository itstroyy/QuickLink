...
export default async function AnalyticsPage() {
  ...
  const [{ data: businesses, error }, { data: events, error: eventsError }] = await Promise.all([
  ...
  if (error) logSupabaseError('admin-analytics-businesses', error)
  if (eventsError) logSupabaseError('admin-analytics-events', eventsError)
