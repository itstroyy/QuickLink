...
export default async function DashboardCatalogPage({ searchParams }: { searchParams: Promise<{ business?: string }> }) {
  ...
  const [products, services, promotions, hours, announcements, gallery, leadForms, leads, notifications] = await Promise.all([
  ...
  return <main className="px-5 py-8 lg:px-10 lg:py-10"><div className="mx-auto max-w-6xl">
    ...
    <p className="mt-2 text-[#77776f]">Products, services, offers, hours and gallery — everything customers see on your public page.</p>
