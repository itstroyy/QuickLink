...
export function OrderModule({ businessId, businessName, products, primary }: { businessId: string; businessName: string; products: Product[]; primary: boolean }) {
