...
import './globals.css'
export const metadata: Metadata = { title: 'Quicklink — One scan. Every link.', description: 'Beautiful QR landing pages for local businesses.', generator: 'Quicklink', manifest: '/manifest.webmanifest', appleWebApp: { capable: true, title: 'Quicklink' } }
