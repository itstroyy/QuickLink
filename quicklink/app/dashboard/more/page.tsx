...
export const metadata: Metadata = { title: 'More — Quicklink', robots: { index: false, follow: false } }
...
export default async function DashboardMorePage({ searchParams }: { searchParams: Promise<{ business?: string }> }) {
  ...
  return <main className="px-5 py-8 lg:px-10 lg:py-10"><div className="mx-auto max-w-4xl">
    ...
    <h1 className="mt-2 text-3xl font-semibold tracking-tight sm:text-4xl">More</h1>
    <p className="mt-2 text-[#77776f]">Business profile, appearance and links. Notifications and Google Calendar are on the Catalog page.</p>
